...
<body>
		...
		<div class="form signup">
		  ...
		  <form action="./member_update_action" method="post">
		  	<div class = "form-element" style = "font-weight: bold; color : white; text-align: center">Update your Information</div>
		    ...
		    <div class="form-element">
		      <input type="text" placeholder = "Introduce" name="mintro">
		    </div>
		    <div class="form-element">
